            ...
            <div className="max-w-md mx-auto px-6 pt-6 space-y-8">
                ...
                <header className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button className={`w-10 h-10 rounded-full flex items-center justify-center relative shadow-sm transition-colors ${isDarkMode ? 'bg-[#2A2D3A] text-white' : 'bg-white text-gray-600'}`}>
                            <Bell size={20} />
                ...
                <section>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <button className={`${isDarkMode ? 'bg-[#2A2D3A]' : 'bg-white'} p-6 rounded-3xl flex flex-col items-center justify-center gap-3 shadow-md group active:scale-95 transition-all border border-transparent dark:border-gray-800/50`}>
                            <div className={`w-14 h-14 rounded-full flex items-center justify-center text-gray-500 border ${isDarkMode ? 'bg-[#1F2128] border-gray-700' : 'bg-gray-50 border-gray-200'}`}>
                                <Users size={28} />
                            </div>
