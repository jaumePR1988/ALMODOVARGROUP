                        ...
                        {highlights.map(item => (
                            <div key={item.id} className="relative rounded-[2rem] overflow-hidden shadow-xl aspect-[4/3] group">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-6">
                                    ...
                                    <p className="text-gray-200 text-xs line-clamp-2">{item.content}</p>
                                </div>
                                {isAdmin && (
                ...
                <div className="fixed inset-0 z-[100] bg-black/80 flex items-center justify-center p-6 backdrop-blur-sm animate-in fade-in">
                    <div className="bg-white dark:bg-[#2A2D3A] w-full max-w-sm rounded-[2rem] p-6 shadow-2xl space-y-4">
                        ...
                        <textarea
                            ...
                            className="w-full p-4 rounded-xl bg-gray-50 dark:bg-[#1F2128] border-none outline-none dark:text-white h-32 resize-none"
                        />
                        ...
                        <div className="flex gap-2">
                            {['news', 'alert', 'highlight'].map(t => (
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-lg text-xs font-bold uppercase ${newType === t
                                        ? 'bg-[#FF1F40] text-white'
                        ...
                        <input
                            ...
                            className="w-full p-4 rounded-xl bg-gray-50 dark:bg-[#1F2128] border-none outline-none dark:text-white text-xs"
                        />

                        <div className="flex gap-3 pt-2">
                            <button
                                onClick={() => setShowCreateModal(false)}
                                className="flex-1 py-3 text-gray-500 font-bold uppercase text-xs"
                            >
                                Cancelar
                            </button>
                            <button
                                onClick={handleCreate}
                                className="flex-1 py-3 bg-[#FF1F40] text-white rounded-xl font-bold uppercase text-xs shadow-lg shadow-red-500/20"
                            >
                                Publicar
                            </button>
                        </div>
